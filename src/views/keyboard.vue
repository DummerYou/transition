...
<template>
 <div class="keyboard" ontouchstart="">
    <div class="row"><button type="button" class="btn0"><span class="xs">esc</span>
      </button><button type="button" class="btn0" id="F1"><span class="xs noxscale"><span class="emoji">&#128261;</span></span><span
          class="lr xxxs">F1</span>
      </button><button type="button" class="btn0"><span class="xs noxscale"><span class="emoji">&#128262;</span></span><span
          class="lr xxxs">F2</span>
      </button><button type="button" class="btn0"><span class="xs noxscale"><span class="cascade"></span><span class="block"></span></span><span
          class="lr xxxs">F3</span>
      </button><button type="button" class="btn0"><span class="xxxs noxscale"><span class="apps"></span></span><span
          class="lr xxxs">F4</span>
      ...
      </button><button type="button" class="btn0"><span class="sm"><span class="left"></span><span class="left"></span></span><span
          class="lr xxxs">F7</span>
      </button><button type="button" class="btn0"><span class="sm"><span class="right"></span><span class="pause"></span></span><span
          class="lr xxxs">F8</span>
      </button><button type="button" class="btn0"><span class="sm"><span class="right"></span><span class="right"></span></span><span
          class="lr xxxs">F9</span>
      </button><button type="button" class="btn0"><span class="xs noxscale"><span class="emoji">&#128264;</span></span><span
          class="lr xxxs">F10</span>
      </button><button type="button" class="btn0"><span class="xs noxscale"><span class="emoji">&#128265;</span></span><span
          class="lr xxxs">F11</span>
      </button><button type="button" class="btn0"><span class="xs noxscale"><span class="emoji">&#128266;</span></span><span
          class="lr xxxs">F12</span>
    ...
    <div class="row"><button type="button" class="btn3"><span class="ll xs">tab</span>
      </button><button type="button" class="btn2" id="Q"><span>Q</span>
      </button><button type="button" class="btn2" id="W"><span>W</span>
      </button><button type="button" class="btn2" id="E"><span>E</span>
      </button><button type="button" class="btn2" id="R"><span>R</span>
      </button><button type="button" class="btn2" id="T"><span>T</span>
      </button><button type="button" class="btn2" id="Y"><span>Y</span>
      </button><button type="button" class="btn2" id="U"><span>U</span>
      </button><button type="button" class="btn2" id="I"><span>I</span>
      </button><button type="button" class="btn2" id="O"><span>O</span>
      </button><button type="button" class="btn2" id="P"><span>P</span>
      </button><button type="button" class="btn2"><span class="sm">{<br />[</span>
      </button><button type="button" class="btn2"><span class="sm">}<br />]</span>
      </button><button type="button" class="btn2"><span class="sm">|<br />\</span>
      </button>
    ...
    <div class="row"><button type="button" id="caps-lock" class="btn4"><span class="ul xs">•</span><span class="ll xs">caps
          lock</span>
      </button><button type="button" class="btn2" id="A"><span>A</span>
      </button><button type="button" class="btn2" id="S"><span>S</span>
      </button><button type="button" class="btn2" id="D"><span>D</span>
      </button><button type="button" class="btn2" id="F"><span>F</span><span class="bump"></span>
      </button><button type="button" class="btn2" id="G"><span>G</span>
      </button><button type="button" class="btn2" id="H"><span>H</span>
      </button><button type="button" class="btn2" id="J"><span>J</span><span class="bump"></span>
      </button><button type="button" class="btn2" id="K"><span>K</span>
      </button><button type="button" class="btn2" id="L"><span>L</span>
      </button><button type="button" class="btn2"><span class="sm">:<br />;</span>
      </button><button type="button" class="btn2"><span class="sm">&quot;<br />'</span>
    ...
    <div class="row"><button type="button" class="btn5"><span class="ll xs">shift</span>
      </button><button type="button" class="btn2" id="Z"><span>Z</span>
      </button><button type="button" class="btn2" id="X"><span>X</span>
      </button><button type="button" class="btn2" id="C"><span>C</span>
      </button><button type="button" class="btn2" id="V"><span>V</span>
      </button><button type="button" class="btn2" id="B"><span>B</span>
      </button><button type="button" class="btn2" id="N"><span>N</span>
      </button><button type="button" class="btn2" id="M"><span>M</span>
      </button><button type="button" class="btn2"><span class="sm">&lt;<br />,</span>
      </button><button type="button" class="btn2"><span class="sm">&gt;<br />.</span>
      </button><button type="button" class="btn2"><span class="sm">?<br />/</span>
    ...
    <div class="row"><button type="button" class="btn2"><span><span class="left"></span></span></button><button type="button"
        class="btn2"><span><span class="down"></span></span></button><button type="button" class="btn2"><span><span
            class="right"></span></span></button>
    </div>
